...
def parse_arguments(argv):
    ...
    parser.add_argument('--directory', type=str, help='directory', default='..\FaceNet\data\people')
...
# example: py camera.py --first_name Diego --last_name Godínez --maxFileNumber 10
# example: py camera.py --first_name Diego --last_name Godínez --maxFileNumber 10 --directory ..\imgs\imagenesDeEntrada
